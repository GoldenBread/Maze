...
** Last update Sun May 22 22:58:23 2016 Thierry LEVISSE
*/
...
void	set_alrdybeen(t_maze *data, t_misc_bfs *misc)
{
...
void	next_pos(t_position *pos, t_misc_bfs *misc, t_maze *data)
{
  int	cur;
...
void		gimme_path(t_misc_bfs *misc, t_maze *data)
{
  t_position	pos;
